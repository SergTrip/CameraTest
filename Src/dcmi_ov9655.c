...
/**
  * @brief  Set the VGA size(480*640).
  * @param  None
  * @retval None
  */
void DCMI_OV9655_VGASizeSetup(void)
{
  HAL_Delay(TIMEOUT);
  ...
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x11, 0x02);
  HAL_Delay(TIMEOUT);
  ...
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x17, 0x16);
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x18, 0x02);
  HAL_Delay(TIMEOUT);
  ...
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x24, 0x1c);
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x25, 0x16);
  HAL_Delay(TIMEOUT);
  ...
  //DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x3f, 0x00);
  HAL_Delay(TIMEOUT);
  ...
  //DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x42, 0x00);
  HAL_Delay(TIMEOUT);
  ...
  HAL_Delay(TIMEOUT);
  HAL_Delay(TIMEOUT);  
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x72, 0x00);
  HAL_Delay(TIMEOUT);
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0x73, 0x00);
  HAL_Delay(TIMEOUT);
  ...
  HAL_Delay(TIMEOUT);
  DCMI_SingleRandomWrite(OV9655_DEVICE_WRITE_ADDRESS,0xc7, 0x80);
  HAL_Delay(TIMEOUT);
